...
public class QRecommend extends EntityPathBase<Recommend> {
    ...
    public final org.yunhyerim.api.analysis.domain.QAnalysis analysis;
    ...
    public QRecommend(Class<? extends Recommend> type, PathMetadata metadata, PathInits inits) {
        ...
        this.analysis = inits.isInitialized("analysis") ? new org.yunhyerim.api.analysis.domain.QAnalysis(forProperty("analysis"), inits.get("analysis")) : null;
    }
